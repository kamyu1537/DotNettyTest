...
public class MessagePackPacketCodec : MessageToMessageCodec<IByteBuffer, IPacket>
{
    ...
    protected override void Encode(IChannelHandlerContext context, IPacket input, List<object> output)
    {
        ...
        MessagePackSerializer.Serialize(writer, input);
    ...
    protected override void Decode(IChannelHandlerContext context, IByteBuffer input, List<object> output)
    {
        ...
        try
        {
            ...
            var packet = MessagePackSerializer.Deserialize<IPacket>(new ReadOnlyMemory<byte>(array, 0, length));
            if (packet is null)
            {
